...
WebAudio的开发调用方式和其他`JavaScript`环境基本是相同的，建议直接查阅[Web\_Audio\_API](https://developer.mozilla.org/zh-CN/docs/Web/API/Web_Audio_API)进行学习
...
提示：compareVersion 定义可见[版本号比较](../runtime/client-lib/compatibility)。

### [#](#代码片段) 代码片段

我们提供了可运行的[代码片段](https://developers.weixin.qq.com/s/i6Xs7gmq7zXK)，可以预览代码片段并在真机进行体验

[在开发者工具中预览效果](https://developers.weixin.qq.com/s/i6Xs7gmq7zXK)
