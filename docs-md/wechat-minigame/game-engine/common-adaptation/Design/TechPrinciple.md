...
### [#](#_1-WebAssembly-运行时) 1. WebAssembly 运行时
...
### [#](#_2-JavaScript-胶水代码) 2. JavaScript 胶水代码
...
### [#](#Canvas-WebGL-适配) Canvas/WebGL 适配
...
#### [#](#_1-代码解析与分析) 1. 代码解析与分析

-   解析 Emscripten 生成的 JS 代码结构
-   识别 Module 配置和初始化逻辑
-   定位资源加载相关代码

#### [#](#_2-代码注入与修改) 2. 代码注入与修改
...
## [#](#C-与-JavaScript-互调) C++ 与 JavaScript 互调
