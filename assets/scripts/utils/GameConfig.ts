import { _decorator, Component, Node, Sprite, Graphics, Vec3, Color, UITransform, EventTouch } from 'cc';
...
export const ENEMY_TYPES = {
  basic: { hp: 40, speed: 90, reward: 10, color: '#e74c3c', hitRadius: 12 },
  fast: { hp: 25, speed: 160, reward: 15, color: '#f39c12', hitRadius: 10 },
  tank: { hp: 120, speed: 55, reward: 30, color: '#8e44ad', hitRadius: 16 },
} as const;
...
export { _decorator, Component, Node, Sprite, Graphics, Vec3, Color, UITransform, EventTouch };
